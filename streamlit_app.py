...
try:
    ...
    st.error(f"Erro ao importar o módulo 'financial_analyzer_enhanced.py': {e}. Certifique-se de que o arquivo está no diretório correto e todas as dependências (arch, statsmodels) estão instalad[...]")
    st.stop()
